...
export default function RegisterPage() {
  ...
  // Password strength progress (only length-based)
  const strength = Math.min((passwordLength / 12) * 100, 100); // Cap at 100%
  const getStrengthColor = () => {
    if (passwordLength < 6) return 'bg-destructive';
    if (passwordLength < 10) return 'bg-yellow-500';
    return 'bg-green-500';
  };
                  ...
                  <FormItem>
                    ...
                    <div className="mt-2">
                      <div className="flex justify-between text-xs mb-1">
                        <span>Password length: {passwordLength}/12</span>
                      </div>
